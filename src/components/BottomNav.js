...
export default function BottomNav() {
  ...
  return (
    <nav className={`lg:hidden fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around h-16 border-t ${
      ...
      <a href={`https://wa.me/8801795818784?text=${encodeURIComponent('Hello ZEITZONE! I want to enquire about a watch.')}`}
